   ...
   public String pageIndexList(int currentPage, int totalPage)
   {
      ...
      if ( (totalPage>numPerBlock) && (currentPageSetup>0) )
      {
         strList.append(" <nav aria-label='Page navigation example'><ul class='pagination justify-content-center'>"
               + "<li class='page-item'><a href='#' onClick='ajaxRecruitRequest(1); return false' class='page-link'>1</a></li>");
      }
      ...
      if ( (totalPage>numPerBlock) && (currentPageSetup>0) )
      {
         strList.append(" <li class='page-item'><a href='#' onClick='ajaxRecruitRequest(" + n + "); return false' class='page-link'>Prev</a></li>");
      }   
      ...
      while ( (page<=totalPage) && (page<=currentPageSetup+numPerBlock) )
      {
         ...
         {
            strList.append(" <li class='page-item'><a href='#' onClick='ajaxRecruitRequest(" + page + "); return false' class='page-link'>" + page + "</a></li>");
         }
      ...
      {
         strList.append(" <li class='page-item'><a href='#' onClick='ajaxRecruitRequest(" + n + "); return false' class='page-link'>Next</a></li>");
      }
      
      // 마지막 페이지
      if( (totalPage>numPerBlock) && (currentPageSetup+numPerBlock)<totalPage )
      {
         strList.append(" <li class='page-item'><a href='#' onClick='ajaxRecruitRequest(" + totalPage + "); return false'>"+ totalPage + "</a></li></ul></nav>");
      }
