...
public class BeeRequestController implements Controller
{
	//주요 속성 구성
	// → 인터페이스 형태의 자료형을 속성으로 구성
	private IReqBeeDAO dao;

	// setter 구성
	public void setDao(IReqBeeDAO dao)
	{
		this.dao = dao;
	}
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try
		{
			...
			reqBee.setClubmemId(clubmemId);
			reqBee.setBeeId(beeId);
