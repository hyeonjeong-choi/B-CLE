...
public class BeeDAO implements IBeeDAO
{
	...
	public ArrayList<Bee> list(String cid) throws SQLException
	{
		...
		String sql = "SELECT BEE_ID, TYPE_ID, TYPENAME"
				...
				+ ", MIN, MAX, FEE, BDATE, CLUBMEM_ID AS CLUBMEMID, WRITER, NICKNAME, REQCNT"
				+ " FROM CLUBBEEVIEW"
	...
	public int checkClubMem(String id, String cid) throws SQLException
	{
		...
		String sql = "SELECT COUNT(*) AS COUNT FROM MYCLUBVIEW WHERE ID = ? AND CID = ?";
