...
$(function()
{
   $("#searchBtn2").click(function()
   {
      ...
      if($.trim($("#searchValue2").val()) != "")
         keyword = $.trim($("#searchValue2").val());
      
      $(location).attr("href", "clubsearch.action?keyword=" + keyword);
                     ...
                     <li>
                        ...
                        <c:choose>
                           <c:when test="${param.keyword eq null}">
                              ...
                              placeholder="search" aria-label="Search" id="searchValue2">
                           </c:when>
                           <c:otherwise>
                              <input class="form-control me-2" type="search"
                              placeholder="${param.keyword }" aria-label="Search" id="searchValue2">
                           </c:otherwise>
                        </c:choose>
                           <button class="btn btn-outline-success" type="button"
                           id="searchBtn2">Search</button>
                        </form>
                     </li>
