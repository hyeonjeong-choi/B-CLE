...
function ajaxRequest(pageNum)
{
   ...
   var params = "category_l_id=${category_l_id}" +"&category_s_id=" + $("#category_s option:selected").attr("value")
...
<section class="list-title">
   ...
   <div id="contents" class="contents">
      ...
      <div id="searchSet">
         ...
         소분류
         <select id="category_s" >
            <option value="" >전체</option>
            <c:forEach var="cs" items="${cateS }">
               <option value="${cs.category_s_id }">${cs.s_cat }</option>
            </c:forEach>
         </select>
         <br><br>
         지역
         ...
         <div class="input-group" style="width: 400px; margin-left: 35%;">
         <select id="sort" >
            <option value="desc" >최신순</option>
            <option value="asc">등록순</option>
         </select>
         <input type="text" id="searchValue" class="form-control" placeholder="동아리명 검색">
         <button type="button" id="searchBtn" class="btn btn-warning">검색</button> 
         </div>
