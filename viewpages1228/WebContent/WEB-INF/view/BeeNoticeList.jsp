...
-->
	<div id="wrap">
		<div>
			...
			<!-- 동아리 공통 메인 -->
			<c:import url="/meetingmain.action?cid=${sessionCid }&b=b"></c:import>
					...
					<table id="freeboards" class="table">
						...
						<c:forEach var="beenotice" items="${beenoticeList }">
							<tr>
								...
								<td>
									<a href="beenoticearticle.action?beeId=${beenotice.beeId}&cid=${cid}&b=b" style="text-decoration: none;">
										${beenotice.title }
									</a>
								</td>
