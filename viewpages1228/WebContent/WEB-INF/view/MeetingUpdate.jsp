   ...
   <form action="beeupdate.action?cid=${cid }" method="post" id="beeForm">
      ...
      <div class="upper">
         <select class="select" id="typeId" name="typeId">
            <option value="0">모임유형</option>
            
            
            <c:choose>
               <c:when test="${bee.typeId =='1' }">
                  <option value="1" selected="selected">정모</option>
                  <option value="2">반짝모임</option>
               </c:when>
               <c:otherwise>
                  <option value="1">정모</option>
                  <option value="2" selected="selected">반짝모임</option>
               </c:otherwise>
            </c:choose>
         </select> 모임 제목<input type="text" id="title" name="title"  value="${bee.title }" required="required"> 주최자 : ${bee.nickName }
      </div>
      <div class="bottom">
         <div class="intro">
            <h3>모임소개</h3>
         ...
         <div class="bottom2">
            <div class="left">
               ...
               모임장소<input type="text" id="location" name="location" required="required" value="${bee.location }"><br> 
               인원<input type="number" id="min" name="min" required="required" value="${bee.min }"> - <input type="number" id="max" name="max" required="required" value="${bee.max }"><br>
         ...
         <div class="enroll">
            <button id="submitBtn" type="submit" class="btn btn-warning">수정</button>
