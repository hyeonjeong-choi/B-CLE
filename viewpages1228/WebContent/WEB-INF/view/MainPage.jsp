...
<!-- 카테고리 -->
      ...
      <div class="row">
        <div class="col-sm-2">
          <div class="card">
            <div class="card-body" >
            <a href="catclublist.action?category_l_id=1">
        ...
        <div class="col-sm-2">
          <div class="card">
            <div class="card-body">
            <a href="catclublist.action?category_l_id=2">
         ...
         <div class="col-sm-2">
          <div class="card">
            <div class="card-body">
            <a href="catclublist.action?category_l_id=3">
         ...
         <div class="col-sm-2">
          <div class="card">
            <div class="card-body">
            <a href="catclublist.action?category_l_id=4">
        ...
        <div class="col-sm-2">
          <div class="card">
            <div class="card-body">
            <a href="catclublist.action?category_l_id=5">
         ...
         <div class="col-sm-2">
          <div class="card">
            <div class="card-body">
            <a href="catclublist.action?category_l_id=6">
             <img src="images/music.png" alt="">
      ...
      <div class="row">
        <div class="col-sm-2">
          <div class="card">
            <div class="card-body">
            <a href="catclublist.action?category_l_id=7">
        ...
        <div class="col-sm-2">
          <div class="card">
            <div class="card-body">
            <a href="catclublist.action?category_l_id=8">
         ...
         <div class="col-sm-2">
          <div class="card">
            <div class="card-body">
            <a href="catclublist.action?category_l_id=9">
         ...
         <div class="col-sm-2">
          <div class="card">
            <div class="card-body">
            <a href="catclublist.action?category_l_id=10">
         ...
         <div class="col-sm-2">
          <div class="card">
            <div class="card-body">
            <a href="catclublist.action?category_l_id=11">
      ...
      <section class="timeup">
         ...
         <ul>
         	<c:forEach var="randomlist" items="${preOpenClubList }">
	         	<li>
	         		<a href="preopenclubdetail.action?cid=${randomlist.cid }">
	         			<p class="clubpic">
	                    	<img src="images/hobby1.jpg" alt="">
	                  	</p>
	                  	<div class="bottom">
	                    	<p class="color">${randomlist.title }</p>
	                  	</div> 
	                 </a>
	            </li>
         	</c:forEach>
         ...
         <button><a href="clubprelistform.action" style="text-decoration: none;">더 보기</a></button>
      </section>
